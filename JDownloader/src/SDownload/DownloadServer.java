...
class ServerDDemonCliente extends Thread {
 ...
 //   private ArrayList<DatosServerDescarga> DatosServersD;
    //private ;
/**
...
class Funciones {
    ...
    public String CargarVideosCarpeta (ArrayList<Video> ListaVideos, String path){
...
public class DownloadServer {
    ...
    public static void main(String args[]) throws IOException, InterruptedException {
        ...
        String textoListaVideos =Funcion.CargarVideosCarpeta (ListaVideos,path );
        ...
        try {
           ...
           do {
            ...
            SDDaC.Stop();
            Thread.sleep(1000);
          //  System.out.printf( "Eso error no causa al Servidor cerrar es una ");
            //Guardar los datos
            
            //ArrayList<DatosVideo> ListaVideos
            //Guardar lista de videos y sus historiales del txt 


            //ArrayList <DatosCliente> ListaClientes        
            //Guardar lista de Clientes y sus historiales del txt
        }
