            ...
            while(i< Ls.length){
                 ...
                 if (temp.length>2){
                     ...
                     if (indiceVideo==-1){
                        ...
                        ListaVideos.add( videoYServidor ); //si el video no esta en la lista lo agrega
    ...
    public void run() {
        ...
        try {
           // accion = dis.readUTF();
            ...
            //DatosCliente Id= new DatosCliente(this.idUsuario);
            //ArrayList <VideoYServidores> ListaVideos= new ArrayList<VideoYServidores>();
            /// Desconponiendo el texto 
            ...
            System.out.println("Ordeno los videos");
            //ListaVideosOrdenadoAutor= (ArrayList<VideoYServidores>)ListaVideos.clone();
            //Ordenar por nombre de autor
           // Collections.sort(ListaVideosOrdenadoAutor, (VideoForDownloadServer b1, VideoForDownloadServer b2) -> b1.getAutor().compareTo(b2.getAutor()));
            ...
            //Logger.getLogger(ClientConnection.class.getName()).log(Level.SEVERE, null, ex);
            //System.out.println("Se cerro la coneccion con el servidor de descarga: "+ this.indiceServidorDActual+". ");
            Stop();
        }finally {Stop();}
