...
/**
 * CLASE PARA SINCRONIZAR SERVIDORES DE DESCARGA
...
public class SyncConnection extends Thread {
    ...
    public SyncConnection(long byteInicio, int indiceServ,String Ip, int puerto,String nombreVideo,String autorVideo,String id) {
    this.Ip= Ip;
    this.puerto=puerto;
    this.idCliente= id;
    ...
    public void run() {
        ...
        try {
            ...
            try {  
                if (byteInicio==0){
                out = new FileOutputStream("C:\\Videos\\"+nombreArchivo);
                }else {out = new FileOutputStream("C:\\Videos\\"+nombreArchivo, true); }
